...
class _HomeScreenState extends State<HomeScreen>
  ...
  Widget _buildDailyMissionCard() {
    ...
    return DailyMissionCard(
      ...
      missions: missions,
      onClaim: _claimDailyMission,
      onClaimAll: _claimAllDailyMissions,
    );
  }
  ...
  Widget _buildRivalRoadCard() {
    ...
    return RivalRoadCard(
      road: road,
      onTap: road.completed ? null : _startRivalRoadBattle,
    );
  }
  ...
  Widget _buildSeasonPassCard() {
    ...
    return SeasonPassCard(
      pass: pass,
      onClaim: _claimSeasonPassRewards,
    );
  }
