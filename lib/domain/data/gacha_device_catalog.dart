...
const gachaDeviceCatalog = <EmulatedDeviceSpec>[
  ...
  EmulatedDeviceSpec(
    deviceName: 'FruitPhone 17 Pro Max',
    osLabel: 'iOS 19.0',
    osVersion: '19',
    cpuCores: 6,
    ramMB: 12288,
...
/// 期間限定イベント解析だけで排出されるSSR端末。
const eventLimitedDeviceCatalog = <EmulatedDeviceSpec>[
  EmulatedDeviceSpec(
    deviceName: 'ChronoCore X Burst',
    osLabel: 'Android 16.0',
    osVersion: '16',
    cpuCores: 14,
    ramMB: 24576,
  ...
  EmulatedDeviceSpec(
    deviceName: 'Metric Phantom Pro',
    osLabel: 'Android 16.1',
    osVersion: '16',
    cpuCores: 12,
    ramMB: 32768,
    storageFreeGB: 768,
