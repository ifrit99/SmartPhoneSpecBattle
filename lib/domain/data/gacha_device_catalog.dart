...
const gachaDeviceCatalog = <EmulatedDeviceSpec>[
  ...
  EmulatedDeviceSpec(
    ...
    osVersion: '11',
    cpuCores: 4, ramMB: 2048, storageFreeGB: 12, batteryLevel: 45,
    rarity: Rarity.n,
  ),
  EmulatedDeviceSpec(
    deviceName: 'Redmi 9A',
  ...
  EmulatedDeviceSpec(
    ...
    osLabel: 'Android 11.0',
    osVersion: '11',
    cpuCores: 4, ramMB: 3072, storageFreeGB: 16, batteryLevel: 55,
    rarity: Rarity.n,
  ),
  EmulatedDeviceSpec(
    ...
    osLabel: 'Android 11.0',
    osVersion: '11',
    cpuCores: 4, ramMB: 3072, storageFreeGB: 14, batteryLevel: 40,
    rarity: Rarity.n,
  ),
  EmulatedDeviceSpec(
    ...
    osLabel: 'iOS 14.0',
    osVersion: '14',
    cpuCores: 4, ramMB: 3072, storageFreeGB: 18, batteryLevel: 48,
    rarity: Rarity.n,
  ),
  ...
  EmulatedDeviceSpec(
    ...
    osVersion: '13',
    cpuCores: 8, ramMB: 6144, storageFreeGB: 48, batteryLevel: 65,
    rarity: Rarity.r,
  ),
  EmulatedDeviceSpec(
    ...
    osVersion: '14',
    cpuCores: 8, ramMB: 8192, storageFreeGB: 56, batteryLevel: 70,
    rarity: Rarity.r,
  ),
  EmulatedDeviceSpec(
    ...
    osLabel: 'iOS 17.0',
    osVersion: '17',
    cpuCores: 6, ramMB: 6144, storageFreeGB: 64, batteryLevel: 75,
    rarity: Rarity.r,
  ),
  EmulatedDeviceSpec(
    ...
    osLabel: 'Android 14.0',
    osVersion: '14',
    cpuCores: 8, ramMB: 6144, storageFreeGB: 52, batteryLevel: 60,
    rarity: Rarity.r,
  ),
  EmulatedDeviceSpec(
    ...
    osLabel: 'Android 14.0',
    osVersion: '14',
    cpuCores: 8, ramMB: 8192, storageFreeGB: 60, batteryLevel: 68,
    rarity: Rarity.r,
  ),
  ...
  EmulatedDeviceSpec(
    ...
    osVersion: '15',
    cpuCores: 8, ramMB: 12288, storageFreeGB: 128, batteryLevel: 85,
    rarity: Rarity.sr,
  ),
  EmulatedDeviceSpec(
  ...
  EmulatedDeviceSpec(
    ...
    osLabel: 'Android 15.0',
    osVersion: '15',
    cpuCores: 8, ramMB: 16384, storageFreeGB: 160, batteryLevel: 82,
    rarity: Rarity.sr,
  ),
  ...
  EmulatedDeviceSpec(
    ...
    osLabel: 'iOS 19.0',
    osVersion: '19',
    cpuCores: 6, ramMB: 12288, storageFreeGB: 512, batteryLevel: 100,
    rarity: Rarity.ssr,
  ),
  EmulatedDeviceSpec(
